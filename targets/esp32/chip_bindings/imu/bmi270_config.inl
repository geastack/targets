// BMI270 initialization config blob (8192 bytes).
// Vendored from M5Stack M5Unified (src/utility/imu/BMI270_config.inl, MIT),
// which carries Bosch Sensortec's canonical BMI270 config firmware. This is
// data the BMI270's on-chip controller requires before it produces any data.
