#include "touch.h"
#include "chip_bindings/touch/ft6336_controller.h"

namespace {

gea::platform::esp32::chip_bindings::ft6336::TouchController &touchController() {
  return gea::platform::esp32::chip_bindings::ft6336::TouchController::instance();
}
...
// observer to the FT6336 controller so a second contact (pointerId 1) reaches
