#include "touch.h"
#include "chip_bindings/touch/cst9217_controller.h"

namespace {

gea::platform::esp32::chip_bindings::cst9217::TouchController &touchController() {
  return gea::platform::esp32::chip_bindings::cst9217::TouchController::instance();
}
...
int gea::platform::touch::Touchscreen::read(int *x, int *y) {
  gea::platform::esp32::chip_bindings::cst9217::TouchSample sample;
